...
class Transaction{
    ...
    calculateHash(){
        return SHA256(this.fromAddress + this.toAddress + this.address).toString();
    }
...
class Blockchain{
    ...
    createGenesisBlock(){
        return new Block(0, "04/24/2021", "Genesis block", "0");
    }
    ...
    addTransaction(transaction){
        ...
        if(!transaction.fromAddress || !transaction.toAddress){
            throw new Error('Transaction must include to and from!');
        }
